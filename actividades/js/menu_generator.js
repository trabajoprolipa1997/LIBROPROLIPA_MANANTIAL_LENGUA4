$(document).ready(function() {
    ...
    try {
        $.each(mrk, function(index, value) {
            ...
            content_tabs += '<a href="#t' + index + '"class="abc' + index + '" aria-controls="t' + index + '" role="tab" data-toggle="tab">' + value['name'] + '</a>';
    ...
    // console.log($(body_tabs).html() != "" ? $(".btn1-menu").show() : $(".btn1-menu").hide())
