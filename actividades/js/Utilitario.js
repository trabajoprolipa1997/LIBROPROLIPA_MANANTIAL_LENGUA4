...
$(document).ready(function() {
    $("#ayudas").html('').append("Para evaluar y guardar el ejercicio pulsa sobre <span class='hidden'>El botón Calificar / Comprobar</span><span class='glyphicon glyphicon-check' aria-hidden='true'></span> . <br>" +
        ...
        "Para guardar la actividad, pulsa sobre <span class='hidden'>El botón Guardar en local</span><span class='glyphicon glyphicon-floppy-save' aria-hidden='true'></span> . ");
...
function Calculo_nota() {
    ...
    $('img').removeClass('hvr-grow');
    $('select').removeClass('hvr-bounce-in');
    $('.form-control').removeClass('hvr-grow');
    f_tiempo();
}
...
$('.0_5ptsd').html(" ( 0.5 pts. ) <u> Calificación por docente </u>");
$('.0_5pts').html(" ( 0.5 pts. )");
$('.1ptsd').html(" ( 1 pt. ) <u> Calificación por docente </u>");
$('.1pts').html(" ( 1 pt. )");
$('.1_5ptsd').html(" ( 1.5 pts. ) <u> Calificación por docente </u>");
$('.1_5pts').html(" ( 1.5 pts. )");
$('.1_25ptsd').html(" ( 1.25 pts. ) <u> Calificación por docente </u>");
$('.1_25pts').html(" ( 1.25 pts. )");
$('.2ptsd').html(" ( 2 pt. ) <u> Calificación por docente </u>");
$('.2pts').html(" ( 2 pt. )");
$('.2_25ptsd').html(" ( 2.25 pts. ) <u> Calificación por docente </u>");
$('.2_25pts').html(" ( 2.25 pts. )");
$('.2_5ptsd').html(" ( 2.5 pts. ) <u> Calificación por docente </u>");
$('.2_5pts').html(" ( 2.5 pts. )");
$('.3ptsd').html(" ( 3 pts. ) <u> Calificación por docente </u>");
$('.3pts').html(" ( 3 pts. ) ");
$('.3_5ptsd').html(" ( 3.5 pts. ) <u> Calificación por docente </u>");
$('.3_5pts').html(" ( 3.5 pts. ) ");
$('.3_75ptsd').html(" ( 3.75 pts. ) <u> Calificación por docente </u>");
$('.3_75pts').html(" ( 3.75 pts. ) ");
$('.4ptsd').html(" ( 4 pts. ) <u> Calificación por docente </u>");
$('.4pts').html(" ( 4 pts. ) ");
$('.4_5ptsd').html(" ( 4.5 pts. ) <u> Calificación por docente </u>");
$('.4_5pts').html(" ( 4.5 pts. ) ");
$('.5ptsd').html(" ( 5 pts. ) <u> Calificación por docente </u>");
$('.5pts').html(" ( 5 pts. )");
$('.6ptsd').html(" ( 6 pts. ) <u> Calificación por docente </u>");
$('.6pts').html(" ( 6 pts. )");
$('.7ptsd').html(" ( 7 pts. ) <u> Calificación por docente </u>");
$('.7pts').html(" ( 7 pts. )");
$('.7_5ptsd').html(" ( 7.5 pts. ) <u> Calificación por docente </u>");
$('.7_5pts').html(" ( 7.5 pts. )");
$('.8ptsd').html(" ( 8 pts. ) <u> Calificación por docente </u>");
$('.8pts').html(" ( 8 pts. )");
$('.9ptsd').html(" ( 9 pts. ) <u> Calificación por docente </u>");
$('.9pts').html(" ( 9 pts. )");
$('.10ptsd').html(" ( 10 pts. ) <u> Calificación por docente </u>");
$('.10pts').html(" ( 10 pts. ) ");


$('.redactoraudio').html("<button class='btnAudiotext' id='btnEscuchar'>Escuchar</button> <button class='btnAudiotext' id='btnPausarleer'>Detener</button>");