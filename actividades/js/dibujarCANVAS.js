	...
	window.onload=function() {
		...
		coloresdefondo[12].style.borderColor="black";
		...
		anchoinicial=window.innerWidth*80/100;
		prueba.width=window.innerWidth*80/100;
		altoinicial=prueba.height=prueba.width/2;		
	...
	function cambiaaccion(cual) {
		...
		for (var x=0; x<acciones.length; x++) {
			if (acciones[x]===cual) {
				acciones[x].style.borderColor="black";
